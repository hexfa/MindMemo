...
class HomeViewModel @Inject constructor(
    ...
    private val _getAllNotes : MutableStateFlow<DataStatus<List<MemoEntity>>?> = MutableStateFlow(null)
    val getAllNotes = _getAllNotes.asStateFlow()

    private val _searchNotes : MutableStateFlow<DataStatus<List<MemoEntity>>?> = MutableStateFlow(null)
